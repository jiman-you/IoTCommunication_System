...
public class TongsinUpdateDeviceHandlerTest {
    ...
    @Test
    public void testTongsinUpdateDeviceHandler() {
        TongsinUpdateDeviceHandler handler = new TongsinUpdateDeviceHandler(s3Client);
